...
- Authority: Ofcom
- Source: `Technical parameters for broadcast radio transmitters` — current MF CSV
...
- Limitations: radiation-pattern detail is preserved as regulator provenance but is not yet modeled in the reception rank
